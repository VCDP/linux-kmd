...
const struct intel_lmtt_ops pvc_lmtt_ops = {
	.root_pd_level = pvc_lmtt_root_pd_level,
	.pte_num = pvc_lmtt_pte_num,
	.pte_size = pvc_lmtt_pte_size,
	.pte_shift = pvc_lmtt_pte_shift,
	.pte_idx = pvc_lmtt_pte_idx,
	.pte_encode = pvc_lmtt_pte_encode,
	.pte_write = pvc_lmtt_pte_write,
	.leaf_pt = pvc_lmtt_leaf_pt,
};
