...
/* DSS */
#if defined(CPTCFG_OMAP2_DSS_DEBUGFS)
struct dss_debugfs_entry *
...
#endif /* CPTCFG_OMAP2_DSS_DEBUGFS */
...
#ifdef CPTCFG_OMAP2_DSS_COLLECT_IRQ_STATS
